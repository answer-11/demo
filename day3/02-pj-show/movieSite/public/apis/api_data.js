define({ "api": [
  ...
  },
  {
    ...
    "group": "电影下单接口",
    "version": "0.1.0",
    "description": "<p>Xxx公司的电影下单接口。该接口为 H5 支付。</p>",
    "permission": [
      {
        "name": "admin"
      }
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "redirect_url",
            "description": "<p>支付成功后的回跳url地址，需要在地址下，引导用户做查单操作 非必须</p>"
          }
        ]
      }
    },
    ...
    "filename": "controllers/api/H5Controller.js",
    "groupTitle": "电影下单接口",
    "sampleRequest": [
      {
        "url": "https://h5.woaikaifa.com/api/v1/h5/buy"
      }
    ]
  },
  {
